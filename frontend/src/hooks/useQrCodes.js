...
export function useBulkDeleteQrCodes() { const client = useQueryClient(); return useMutation({ mutationFn: service.bulkDeleteQrCodes, onSuccess: () => client.invalidateQueries({ queryKey: qrCodeKeys.all }) }); }
